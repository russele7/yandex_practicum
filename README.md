...
| [Предсказание цен автомобиля]() | Обучить модель для определения рыночной стоимости автомобиля   | pandas, numpy, matplotlib, seaborn, sklearn, XGB, LightGBM, Catboost |
